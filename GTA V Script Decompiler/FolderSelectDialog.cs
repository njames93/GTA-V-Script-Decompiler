...
namespace System.Windows.Forms
{
    internal class FolderSelectDialog : IDisposable
    {
        ...
        /// Default constructor
        /// </summary>
        public FolderSelectDialog(string initialdir = null)
        {
            ...
            if (initialdir != null) ofd.InitialDirectory = initialdir;
        ...
        public DialogResult ShowDialog(IntPtr hWndOwner)
        {
            ...
            if (flag) return DialogResult.OK; else return DialogResult.Cancel;
        }
