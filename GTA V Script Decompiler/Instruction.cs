...
namespace Decompiler
{
    ...
    public class RDR1355OpcodeSet : OpcodeSet
    {
        ...
        public static readonly Dictionary<Instruction, int> ShuffledInstructions = new Dictionary<Instruction, int> {
            ...
            { Instruction.ILT, 53 },
            { Instruction.ILE, 119 },
            { Instruction.FADD, 113 },
            { Instruction.FSUB, 81 },
            { Instruction.FMUL, 36 },
            { Instruction.FDIV, 12 },
            { Instruction.FMOD, 27 },
            { Instruction.FNEG, 101 },
            { Instruction.FEQ, 125 },
            { Instruction.FNE, 87 },
            { Instruction.FGT, 49 },
            { Instruction.FGE, 22 },
            ...
            { Instruction.VDIV, 18 },
            { Instruction.VNEG, 97 },
            { Instruction.IAND, 105 },
            { Instruction.IOR, 48 },
            { Instruction.IXOR, 73 },
            { Instruction.I2F, 54 },
            { Instruction.F2I, 69 },
            { Instruction.F2V, 56 },
            { Instruction.PUSH_CONST_U8, 109 },
            { Instruction.PUSH_CONST_U8_U8, 111 },
            { Instruction.PUSH_CONST_U8_U8_U8, 123 },
            { Instruction.PUSH_CONST_U32, 134 }, // Verify
            { Instruction.PUSH_CONST_F, 55 }, // Verify
            { Instruction.DUP, 106 },
            { Instruction.DROP, 65 },
            { Instruction.NATIVE, 3 },
            { Instruction.ENTER, 34 },
            { Instruction.LEAVE, 80 },
            { Instruction.LOAD, 118 },
            { Instruction.STORE, 50 },
            { Instruction.STORE_REV, 61 },
            { Instruction.LOAD_N, 45 },
            { Instruction.STORE_N, 6 },
            { Instruction.ARRAY_U8, 99 },
            { Instruction.ARRAY_U8_LOAD, 23 },
            { Instruction.ARRAY_U8_STORE, 100 },
            { Instruction.LOCAL_U8, 75 },
            { Instruction.LOCAL_U8_LOAD, 102 },
            { Instruction.LOCAL_U8_STORE, 103 },
            { Instruction.STATIC_U8, 137 },
            { Instruction.STATIC_U8_LOAD, 84 },
            { Instruction.STATIC_U8_STORE, 78 },
            { Instruction.IADD_U8, 92 },
            { Instruction.IMUL_U8, 20 },
            { Instruction.IOFFSET, 86 },
            { Instruction.IOFFSET_U8, 128 },
            { Instruction.IOFFSET_U8_LOAD, 39 },
            { Instruction.IOFFSET_U8_STORE, 108 },
            { Instruction.PUSH_CONST_S16, 37 },
            { Instruction.IADD_S16, 59 },
            { Instruction.IMUL_S16, 127 },
            { Instruction.IOFFSET_S16, 24 },
            { Instruction.IOFFSET_S16_LOAD, 120 },
            { Instruction.IOFFSET_S16_STORE, 140 },
            { Instruction.ARRAY_U16, 64 },
            { Instruction.ARRAY_U16_LOAD, 2 },
            { Instruction.ARRAY_U16_STORE, 10 },
            { Instruction.LOCAL_U16, 88 },
            { Instruction.LOCAL_U16_LOAD, 1 },
            { Instruction.LOCAL_U16_STORE, 68 },
            { Instruction.STATIC_U16, 70 },
            { Instruction.STATIC_U16_LOAD, 58 },
            { Instruction.STATIC_U16_STORE, 95 },
            { Instruction.GLOBAL_U16, 135 },
            { Instruction.GLOBAL_U16_LOAD, 112 },
            { Instruction.GLOBAL_U16_STORE, 74 },
            { Instruction.J, 104 },
            { Instruction.JZ, 139 },
            { Instruction.IEQ_JZ, 21 },
            { Instruction.INE_JZ, 114 },
            { Instruction.IGT_JZ, 46 },
            { Instruction.IGE_JZ, 117 },
            { Instruction.ILT_JZ, 138 },
            { Instruction.ILE_JZ, 35 },
            { Instruction.CALL, 57 },
            { Instruction.GLOBAL_U24, 93 },
            { Instruction.GLOBAL_U24_LOAD, 133 },
            { Instruction.GLOBAL_U24_STORE, 38 },
            { Instruction.PUSH_CONST_U24, 33 },
            { Instruction.SWITCH, 60 },
            { Instruction.STRING, 4 },
            { Instruction.STRINGHASH, 129 },
            { Instruction.TEXT_LABEL_ASSIGN_STRING, 31 },
            { Instruction.TEXT_LABEL_ASSIGN_INT, 121 },
            { Instruction.TEXT_LABEL_APPEND_STRING, 94 },
            { Instruction.TEXT_LABEL_APPEND_INT, 41 },
            { Instruction.TEXT_LABEL_COPY, 26 },
            { Instruction.CATCH, 110 },
            { Instruction.THROW, 85 },
            { Instruction.CALLINDIRECT, 141 },
            { Instruction.PUSH_CONST_M1, 8 },
            { Instruction.PUSH_CONST_0, 47 }, // Verify.
            { Instruction.PUSH_CONST_1, 9 },
            { Instruction.PUSH_CONST_2, 17 },
            { Instruction.PUSH_CONST_3, 29 },
            { Instruction.PUSH_CONST_4, 66 },
            { Instruction.PUSH_CONST_5, 98 },
            { Instruction.PUSH_CONST_6, 77 },
            { Instruction.PUSH_CONST_7, 13 },
            { Instruction.PUSH_CONST_FM1, 76 },
            { Instruction.PUSH_CONST_F0, 115 }, // Verify.
            { Instruction.PUSH_CONST_F1, 72 },
            { Instruction.PUSH_CONST_F2, 91 },
            { Instruction.PUSH_CONST_F3, 44 },
            { Instruction.PUSH_CONST_F4, 90 },
            { Instruction.PUSH_CONST_F5, 124 },
            { Instruction.PUSH_CONST_F6, 122 },
            { Instruction.PUSH_CONST_F7, 51 },
            // RDR3 extended
            { Instruction.LOCAL_LOAD_S, 15 },
            { Instruction.LOCAL_STORE_S, 0 },
            { Instruction.LOCAL_STORE_SR, 82 },
            { Instruction.STATIC_LOAD_S, 14 },
            { Instruction.STATIC_STORE_S, 79 },
            { Instruction.STATIC_STORE_SR, 116 },
            { Instruction.LOAD_N_S, 136 },
            { Instruction.STORE_N_S, 83 },
            { Instruction.STORE_N_SR, 130 },
            { Instruction.GLOBAL_LOAD_S, 131 },
            { Instruction.GLOBAL_STORE_S, 63 },
            { Instruction.GLOBAL_STORE_SR, 42 },
            // >= 1311
            { Instruction.STATIC_U24, 62 },
            { Instruction.STATIC_U24_LOAD, 107 },
            { Instruction.STATIC_U24_STORE, 40 },
        };
