...
namespace Decompiler
{
    ...
    {																												  
        ...
        {
            Stream natfile = File.Create(Path.Combine(Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location), "nativeinfo.dat"));
        ...
        public void loadfile()
        {
            ...
            string file = Path.Combine(Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location), "nativeinfo.dat");
            if (!File.Exists(file))
                return;
        ...
        {
            Stream natfile = File.Create(Path.Combine(Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location), "natives.h"));
