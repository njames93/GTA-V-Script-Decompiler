namespace System.Windows.Forms
{
    ...
    internal class _InputBox : Form
    {
        ...
        internal string Value
        {
            get
            {
                return this.DialogResult == DialogResult.OK ? (inputtype == type.dropdown ? comboBox1.Text : (inputtype == type.text ? textBox1.Text : null)) : Default;
            }
        }
        internal string[] ListValue
        {
            get
            {
                return this.DialogResult == DialogResult.OK && inputtype == type.list ? richTextBox1.Lines : null;
            }
        }
    ...
    public class InputBox : IDisposable
    {
        ...
        public string[] ListValue
        {
            get
            {
                return _ibx.ListValue;
            }
        }

        public bool Show(string TitleMessage = null, string Message = null, string DefaulResponse = null, IWin32Window owner = null)
        {
        ...
        public static string QuickShow(string TitleMessage=null, string Message=null, string DefaultResponse=null, IWin32Window owner=null)
        {
            _InputBox ibx = new _InputBox();
